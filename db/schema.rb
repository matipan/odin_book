...
ActiveRecord::Schema.define(version: 20151006171408) do
  ...
  add_index "notifications", ["sender_id", "user_id", "title"], name: "index_notifications_on_sender_id_and_user_id_and_title", unique: true, using: :btree
